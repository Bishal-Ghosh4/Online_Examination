                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Technology Add </h3>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputFirstName" type="text"
                                                        name="techname" placeholder="Enter your first name" />
                                ...
                                <div class="mt-4 mb-0">
                                    <div class="d-grid">
                                        <a href="/technology/question"><input type="submit" class="btn btn-info btn-block" name="btn"
                                            value="Add Questions"></a>
                                    </div>
                                </div>
